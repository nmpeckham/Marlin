...
#define STRING_CONFIG_H_AUTHOR "Nathan Peckham" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ass Destroyer"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 17.32
  #define DEFAULT_bedKi 0.98
  #define DEFAULT_bedKd 203.58
